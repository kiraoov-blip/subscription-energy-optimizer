...
APP_VERSION = "2026-07-21-actual-tou-v26.0"
...
def build_glossary() -> pd.DataFrame:
    ...
    # 사이드바 분석·요금 설정
    add("사이드바", "분석 설정", "분석 설정", "군집 수와 요금 가정 등 시뮬레이션 조건을 바꾸는 영역입니다.")
    add("사이드바", "분석 설정", "공통 군집 수", "고객을 사용패턴이 비슷한 몇 개 그룹으로 나눌지를 정합니다.", "3~8개 중 선택합니다.", "군집 수가 달라지면 고객의 군집 유형도 달라질 수 있습니다.")
    ...
    add("2024~2025년 사용량 분석", "핵심 지표", "동일 군집 유지 비율", "2024년과 2025년에 같은 사용패턴 군집으로 분류된 고객의 비율입니다.", "같은 군집 고객 수 ÷ 712명.")
    ...
    add("고객별 요금 모니터링", "조회 조건", "군집 필터", "선택한 사용패턴 군집에 속한 고객만 표시합니다.")
    ...
    add("고객별 진단·제어", "고객 진단", "최근 변화 신호", "사용량 급증·급감, 군집 이동, 추천요금제 변경처럼 두 해 사이에 눈에 띄는 변화가 있는지 알려줍니다.")
    add("고객별 진단·제어", "고객 진단", "군집 이동", "고객의 사용패턴 유형이 2024년과 2025년에 달라진 상태입니다.")
    add("고객별 진단·제어", "고객 진단", "연간 종합진단", "선택 고객의 2개년 월별 사용량, 연간 요금, 군집과 추천요금제 변화를 종합해 보는 화면입니다.")
    ...
    # 군집 분석
    add("고객 군집 분석", "군집", "군집", "사용량과 시간대 패턴이 비슷한 고객을 묶은 그룹입니다.")
    add("고객 군집 분석", "군집", "공통 기준 군집", "2024년과 2025년 고객을 같은 기준으로 비교할 수 있도록 두 해에 동일한 군집 중심을 적용한 분류입니다.")
    add("고객 군집 분석", "군집", "군집 유형", "저사용·야간형·하계민감형 등 해당 고객군의 대표 사용특성을 요약한 이름입니다.", "생활형태나 가전 보유를 확정하는 진단은 아닙니다.")
    add("고객 군집 분석", "군집", "고객수(명)", "해당 군집 또는 군집 이동경로에 포함된 고객 수입니다.")
    add("고객 군집 분석", "군집", "비중(%)", "전체 분석 고객 중 해당 군집 고객이 차지하는 비율입니다.")
    add("고객 군집 분석", "군집", "연간 사용량(kWh)", "해당 군집 고객의 평균 연간 사용량입니다.")
    add("고객 군집 분석", "군집", "최대시간 사용량(kWh)", "한 시간에 사용한 전력량 중 가장 큰 값의 군집 평균입니다.", "1시간 자료이므로 수치상 평균 kW와 유사하게 해석할 수 있습니다.")
    add("고객 군집 분석", "군집", "주중 대비 주말 사용량 비중(%)", "주중 하루 사용량에 비해 주말 하루 사용량이 어느 정도인지를 나타냅니다.", "주말 일평균 ÷ 주중 일평균 × 100.")
    add("고객 군집 분석", "군집", "경부하 비중(%)", "전체 사용량 중 22~08시에 사용한 비율입니다.")
    add("고객 군집 분석", "군집", "중간부하 비중(%)", "전체 사용량 중 08~16시에 사용한 비율입니다.")
    add("고객 군집 분석", "군집", "최대부하 비중(%)", "전체 사용량 중 16~22시에 사용한 비율입니다.")
    add("고객 군집 분석", "군집", "월 변동계수(%)", "월별 사용량이 연중 얼마나 들쭉날쭉한지를 나타냅니다.", "월별 표준편차 ÷ 월평균 × 100.", "높을수록 계절 또는 생활변화 영향이 큽니다.")
    add("고객 군집 분석", "군집", "부하율(%)", "최대부하에 비해 평균부하가 얼마나 높은지를 나타냅니다.", "평균부하 ÷ 최대부하 × 100.", "높을수록 하루 사용이 비교적 평탄합니다.")
    add("고객 군집 분석", "군집", "하계 민감도(%)", "여름 사용량이 연평균보다 얼마나 높거나 낮은지를 나타내는 상대지표입니다.", "여름 월평균 ÷ 연간 월평균을 비율로 표시합니다.")
    add("고객 군집 분석", "군집", "동계 민감도(%)", "겨울 사용량이 연평균보다 얼마나 높거나 낮은지를 나타내는 상대지표입니다.")
    add("고객 군집 분석", "군집", "동일 군집 유지율", "두 해에 같은 군집 유형을 유지한 고객 비율입니다.")
    add("고객 군집 분석", "군집", "군집 이동 고객", "2024년과 2025년의 군집 유형이 달라진 고객 수입니다.")
    add("고객 군집 분석", "군집", "군집 전이행렬", "2024년 군집 고객이 2025년에 어느 군집으로 이동했는지를 행과 열로 보여주는 표·그림입니다.")
    add("고객 군집 분석", "군집", "2024군집내비중(%)", "2024년 해당 군집 고객 중 특정 2025년 군집으로 이동한 비율입니다.")
    ...
    add("방법론·한계", "한계", "군집의 한계", "군집은 통계적으로 비슷한 고객을 묶은 것이며 실제 생활유형을 확정하지 않는다는 뜻입니다.")
...
T1,T2,T3,T4,T5,T6,T7,T8=st.tabs(["2024~2025년 사용량 분석","고객별 요금 모니터링","고객별 진단·제어","고객 군집 분석","요금분석 및 추천","계통영향 분석 및 제어 시뮬레이션","방법론·한계","용어·문구 해설"])
...
with T2:
    ...
    if not monitor.empty:
        ...
        st.download_button("고객별 요금 모니터링 CSV",show.to_csv(index=False).encode("utf-8-sig"),f"v26_{year}_{period}_요금모니터링.csv","text/csv")
...
with T5:
    ...
    st.download_button("연간 추천요금제 고객표 CSV",annual_show.to_csv(index=False).encode("utf-8-sig"),f"v26_{annual_year}_연간추천요금제.csv","text/csv")
    ...
    st.download_button("월별 추천요금제 고객표 CSV",monthly_show.to_csv(index=False).encode("utf-8-sig"),f"v26_{monthly_year}_{monthly_month}월_추천요금제.csv","text/csv")
...
with T6:
    ...
    ps=round_table(ptable);st.dataframe(ps.sort_values("2025년 연간 사용량(kWh)",ascending=False),hide_index=True,use_container_width=True,column_config=dataframe_config(ps));st.download_button("100가구 분석결과 ZIP",zip_results({"100가구_고객목록.csv":ps.to_csv(index=False).encode("utf-8-sig"),"100가구_변압기제어상세.csv":round_table(control).to_csv(index=False).encode("utf-8-sig")}),"v26_100가구_분석결과.zip","application/zip")
...
4. **고객 군집 분석**에서 비슷한 사용패턴의 고객군과 군집 이동을 확인합니다.  
