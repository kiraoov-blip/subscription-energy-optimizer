...
APP_VERSION = "2026-07-14-actual-tou-v10.0"
...
with TAB4:
    ...
    q1,q2,q3=st.columns(3);q1.metric("기준 최대부하",f"{base.max():.1f} kW");q2.metric("제어 후 최대부하",f"{after.max():.1f} kW");q3.metric("대표일 실제 감축",f"{reduced:.1f} kWh")
